...
## ADR-095: A washout washes out to one side, so the 2 and the 3 cannot both stand
...
## ADR-108: A lane machine's own program file is a third way into the catalog
